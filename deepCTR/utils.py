...
class SingleFeat(namedtuple('SingleFeat', ['name', 'dimension', 'hash_flag', 'dtype'])): # namedtuple 轻量字典，元素不可变
    __slots__ = ()
...
class VarLenFeat(namedtuple('VarLenFeat', ['name', 'dimension', 'maxlen', 'combiner', 'hash_flag', 'dtype'])):
    ...
    def __new__(cls, name, dimension, maxlen, combiner="mean", hash_flag=False, dtype="float32"): # combiner?
